    ...
    return(
        <div>
            {/* <form onSubmit={handleSubmit}>
                <div className="text-bold font-xl">Login</div>
                <div className="">
                ...
                <button disabled={pending?true:false} className="" type="submit">{pending?"Logging in":"Login"}</button>
            </form> */}
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleSubmit} className="space-y-6" action="#" method="POST">
            ...
            <div className="flex justify-center items-center">
                <Link href={"/register"} className="text-blue-300 underline mx-auto">Register</Link>
            </div>
          </form>
